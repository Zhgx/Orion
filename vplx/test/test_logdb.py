...
class TestLogDB:
    ...
    def test_insert_data(self):
        ...
        data = ('2020/10/28 16:05:39', self.tid, 'test', 'DATA', 'STR', 'cmd_input', '6311017008', "{'valid': '1', 'cmd': 'stor -h'}")
    ...
    def test_get_userinput_via_time(self):
        ...
        assert self.log.get_userinput_via_time(star_time, end_time) == [{'cmd': 'stor -h', 'tid': '1603872339', 'valid': '1'}]
    ...
    def test_get_oprt_result(self):
        assert self.log.get_oprt_result('6311017008') == {'result': "{'valid': '1', 'cmd': 'stor -h'}", 'time': '2020/10/28 16:05:39'}

    def test_get_id(self):
        assert self.log.get_id(self.tid, 'cmd_input') == {'db_id': 1, 'oprt_id': "{'valid': '1', 'cmd': 'stor -h'}", 'time': '2020/10/28 16:05:39'}
